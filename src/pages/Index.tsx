            ...
            <div className="animate-on-scroll text-center sm:text-left">
              ...
              <div className="flex flex-wrap gap-4 mb-6 justify-center sm:justify-start">
                <Facebook 
                  ...
                  onClick={() => window.open('https://www.facebook.com/profile.php?id=61577130358564', '_blank')}
                />
                ...
                <svg 
                  ...
                  viewBox="0 0 24 24" 
                  fill="currentColor"
                  onClick={() => window.open('https://x.com/Trukflow', '_blank')}
                >
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
                <Instagram 
                  className="w-5 h-5 md:w-6 md:h-6 text-gray-400 hover:text-white cursor-pointer transition-colors" 
                  onClick={() => window.open('https://www.instagram.com/trukflow_?igsh=MWhnMjkyZHhmajI4bg%3D%3D&utm_source=qr', '_blank')}
                />
                <a
                  href="https://www.linkedin.com/company/trukflow/"
                  target="_blank"
                ...
                <svg 
                  ...
                  viewBox="0 0 24 24" 
                  fill="currentColor"
                  onClick={() => window.open('https://www.tiktok.com/@trukflow?_r=1&_t=ZS-956KJF8k08e', '_blank')}
                >
