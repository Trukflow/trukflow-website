            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 h-full">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                   Experience the full application free for 30 days. Thereafter, a monthly subscription fee of <span className="font-semibold text-red-500"> KES 199</span> applies to maintain uninterupted access to all services.
                  </p>
                </div>
              </div>
