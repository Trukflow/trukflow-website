        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-screen flex items-center relative z-10">
          <div className="w-full text-center text-white section-content">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
              Join Our <span className="text-orange-500">Broker</span> Network
            </h1>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  ...
                  <div className="w-full max-w-xs text-left">
                    ...
                    <ul className="space-y-2 text-gray-600">
                      <li className="flex items-center">
                        <span className="text-orange-500 mr-2">✓</span> Valid ID card
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="flex justify-center">
                  <div className="w-full max-w-xs text-left">
                    ...
                    <ul className="space-y-2 text-gray-600">
                      <li className="flex items-center">
                        <span className="text-orange-500 mr-2">✓</span> Strong communication skills
                      </li>
                      <li className="flex items-center">
                        <span className="text-orange-500 mr-2">✓</span> Basic understanding of logistics
                      </li>
                      <li className="flex items-center">
                        <span className="text-orange-500 mr-2">✓</span> Smartphone for app usage
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border-2 border-gray-200">
              <div className="text-center">
                ...
                <div className="mb-6">
                  <span className="text-4xl font-bold text-orange-500">KES 199</span>
            ...
            {/* Quarterly Plan */}
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border-2 border-orange-500 relative">
              ...
              <div className="text-center">
                ...
                <div className="mb-6">
                  <span className="text-4xl font-bold text-orange-500">KES 499</span>
                  <span className="text-gray-600">/3 months</span>
                  <div className="text-sm text-orange-600 font-medium">Save KES 98</div>
                </div>
                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-center">
                    <span className="text-orange-500 mr-2">✓</span>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border-2 border-gray-200">
              <div className="text-center">
                ...
                <div className="mb-6">
                  <span className="text-4xl font-bold text-orange-500">KES 1,599</span>
                  <span className="text-gray-600">/year</span>
                  <div className="text-sm text-orange-600 font-medium">Save KES 789</div>
                </div>
                <ul className="space-y-3 mb-8 text-left">
                  <li className="flex items-center">
                    <span className="text-orange-500 mr-2">✓</span>
